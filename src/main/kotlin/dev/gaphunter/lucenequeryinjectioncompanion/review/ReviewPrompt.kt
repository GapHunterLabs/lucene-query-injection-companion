package dev.gaphunter.lucenequeryinjectioncompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.lucenequeryinjectioncompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.lucenequeryinjectioncompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "Lucene Query Injection Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/34078-lucene-query-injection-companion/reviews"
